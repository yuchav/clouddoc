...
class qiniucallback extends Base
{
	public function post(){
		...
		$mysql = new MySqlUtil();
		$sql = 'INSERT INTO UploadFile (type, parent_id, owner_account_id, file_name, key_preview, key_thumb, is_processing, persistent_id,create_time, mod_time, bucket, file_size, mime_type, key_orignal) ' . 
